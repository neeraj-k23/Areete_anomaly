...
def detect_anomalies(series):
    ...
    upper_threshold = np.percentile(series, 95)
                ...
                if current_date and current_time:
                    ...
                    if window_value:
                        ...
                        if window_type == 'long':
                            ...
                            long_term_anomalies = detect_anomalies(df_hourly_means['mean'])
                            long_term_anomaly_points = df_hourly_means[long_term_anomalies]

                            fig.add_trace(go.Scatter(x=long_term_anomaly_points['time'], y=long_term_anomaly_points['mean'],
                        ...
                        if window_type == 'short':
                            ...
                            short_term_anomalies = detect_anomalies(short_term_means[column])
                            short_term_anomaly_points = short_term_means[short_term_anomalies]
